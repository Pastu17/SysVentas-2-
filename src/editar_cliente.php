...
if (!empty($_POST)) {
    $alert = "";
    if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['cedula'] || empty($_POST['direccion']))) {
        ...
        $direccion = $_POST['direccion'];
            $sql_update = mysqli_query($conexion, "UPDATE cliente SET nombre = '$nombre' , telefono = '$telefono', cedula = '$cedula', direccion = '$direccion' WHERE idcliente = $idcliente");
                ...
                <div class="card-body">
                    <form class="" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" placeholder="Ingrese Cedula" name="cedula" class="form-control" id="telefono" value="<?php echo $cedula; ?>">
                        </div>
                        <div class="form-group">
