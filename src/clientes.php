...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion']) || empty($_POST['cedula'])) {
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO cliente(nombre, telefono, cedula, direccion, usuario_id) VALUES ('$nombre', '$telefono', '$cedula', '$direccion', '$usuario_id')");
            if ($query_insert) {
            ...
            <div class="modal-body">
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Ingrese Cédula" name="cedula" id="cedula" class="form-control">
                    </div>
                    <div class="form-group">
