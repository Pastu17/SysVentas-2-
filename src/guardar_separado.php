...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'separar') {
        ...
        $query_separados = "INSERT INTO separados (nombre_cl, dire_cliente, ced_cliente, tele_cliente, nomb_separado, precio_separado) VALUES (?, ?, ?, ?, ?, ?)";
        $stmt_separar = mysqli_prepare($conexion, $query_separados);
        mysqli_stmt_bind_param($stmt_separar, "ssssss", $nombre_cl, $dire_cliente, $ced_cliente, $tele_cliente, $nom_separado, $pre_separado);
        $result_separar = mysqli_stmt_execute($stmt_separar);
        ...
        <tbody>
            ...
            while ($data = mysqli_fetch_assoc($query_separados)) {
                ...
                <tr>
                    ...
                    <td><?php echo $data['precio_separado']; ?></td>
                    <td>
                        <a>
                            <button class="btn btn-primary mb-2" type="button" data-toggle="modal" data-target="#nuevo_abonar"><i class="fas fa-plus"></i></button>
                        </a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="guardar_separado.php" method="post">
                    ...
                    <input type="submit" value="Separar" class="btn btn-primary">
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form action="guardar_abono.php" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre_cl_abono" id="nombre_cl_abono" class="form-control" placeholder="Ingrese nombre del cliente" value="">
                    </div>
                    <div class="form-group">
